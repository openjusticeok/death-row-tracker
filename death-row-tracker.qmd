...
leaflet(map_data,
  ...
  addPolygons(
    weight = 1,  
    color = "#ffffff",
    fillColor = ~colorBin("YlOrRd", total_cases,
...
Cases are ordered by execution date and PPB hearing date.
...
DT::datatable(
  ...
  options = list(
    ...
    columnDefs = list(
      list(
        targets = 9, className = "none")  # Hide the case events column (0-indexed bc javascript)
    )
  ),
  selection = "none",
  rownames = FALSE,
